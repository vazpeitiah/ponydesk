 ...
 * @author vladi
 */
public class JFVeterinario extends JInternalFrameCustom {
    ...
    public static void actualizarTablaVeterinarios(String name) {
        DefaultTableModel modelo_actual = (DefaultTableModel) tableVeterinarios.getModel();
        tableVeterinarios.setModel(VeterinarioController.getModelVeterinarios(modelo_actual, name));
    }
    ...
    private void initComponents() {
        ...
        tableVeterinarios = new ponyvet.gui.utilities.JTableCustom();
        ...
        tableVeterinarios.setFocusable(false);
        tableVeterinarios.getTableHeader().setReorderingAllowed(false);
        tableVeterinarios.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableVeterinariosMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tableVeterinarios);
        if (tableVeterinarios.getColumnModel().getColumnCount() > 0) {
            tableVeterinarios.getColumnModel().getColumn(0).setMinWidth(60);
            tableVeterinarios.getColumnModel().getColumn(0).setPreferredWidth(100);
            tableVeterinarios.getColumnModel().getColumn(0).setMaxWidth(100);
            tableVeterinarios.getColumnModel().getColumn(1).setMinWidth(60);
            tableVeterinarios.getColumnModel().getColumn(2).setMinWidth(60);
            tableVeterinarios.getColumnModel().getColumn(3).setMinWidth(60);
            tableVeterinarios.getColumnModel().getColumn(3).setPreferredWidth(120);
            tableVeterinarios.getColumnModel().getColumn(3).setMaxWidth(120);
        }
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/icons8-veterinarian-male-32.png"))); // NOI18N
    ...
    private void tableVeterinariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableVeterinariosMouseClicked
        ...
        if (evt.getClickCount() == 2 && tableVeterinarios.getSelectedRowCount() > 0) {
            Point point = evt.getPoint();
            int row = tableVeterinarios.rowAtPoint(point);
            String id = (String) tableVeterinarios.getValueAt(row, 0);
            Veterinario vet = new VeterinarioController().findById(Integer.parseInt(id));
            JDFormularioVeterinario editForm = new JDFormularioVeterinario(null, true, vet);
    ...
    private void txtBuscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyPressed
        // TODO add your handling code here:
        //actualizarTablaVeterinarios(txtBuscar.getText());
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!txtBuscar.getText().equals("")) {
                actualizarTablaVeterinarios(txtBuscar.getText());
                if (tableVeterinarios.getRowCount() <= 0) {
                    JOptionPane.showMessageDialog(null, "No se encontraron resultados con ese nombre");
                    actualizarTablaVeterinarios("");
                }
            } else {
                JOptionPane.showMessageDialog(null, "Debes escribir el nombre del veterinario en el cuadro de búsqueda.");
            }
        }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        JDFormularioVeterinario formulario = new JDFormularioVeterinario(new JFrame(), true, null);
        formulario.setVisible(true);
    }//GEN-LAST:event_btnAgregarActionPerformed

    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        // TODO add your handling code here:
        if (tableVeterinarios.getSelectedRowCount() > 0) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (tableVeterinarios.getSelectedRowCount() > 0) {
            ...
            if (resp == 0) {
                ...
                VeterinarioController.delete(vet);
    ...
    public static ponyvet.gui.utilities.JTableCustom tableVeterinarios;
