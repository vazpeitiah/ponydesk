...
public class JFSalida extends JInternalFrameCustom{
    ...
    public static boolean agregarArticuloConClave(String clave, float cantidad) {
        ...
        if (art != null) {
            ...
            JOptionPane.showMessageDialog(null, "No se encontro el artículo");
        }
        return resultado;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!txtBuscar.getText().equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "Desde de escribir la clave  del artículo en el cuadro de búsqueda, o en caso de contar\n"
                                              + "con un lector de códigos de barras, simplemente escaneá el código del artículo y este\n"
                                              + "se añadira automáticamente al carrito.\n");
        }
