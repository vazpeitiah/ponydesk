...
public class JDVerLotes extends javax.swing.JDialog {
    
    public JDVerLotes(java.awt.Frame parent, boolean modal, String keywords) {
        super(parent, modal);
        initComponents();
        
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        jTable1.setModel(LoteController.getModelLotes(model, keywords));
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Número de lote", "Fecha caducidad", "Existencia inicials", "Existencia actual"
            }
        ) {
